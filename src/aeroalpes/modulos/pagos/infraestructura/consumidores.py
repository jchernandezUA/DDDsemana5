...
from aeroalpes.modulos.pagos.infraestructura.schema.v1.eventos import EventoPagoCreado
from aeroalpes.modulos.pagos.infraestructura.schema.v1.comandos import ComandoCrearPago
